...
def start_video_monitoring(reference_image_path, persona_name):
...
if __name__ == "__main__":
    ...
    persona_name = input("Enter the name of the person in the reference image: ")

    start_video_monitoring("datasets/"+ reference_image_path, persona_name)
